 ...
 * @author ddx
 */
public class SmartTempChart extends CommonChart {
	...
	List<XYItemDateDouble> ds = new ArrayList<>();
        ...
        for (DiskSmart item : items) {
            ...
            ds.add(new XYItemDateDouble(item.getDt(), (double)item.Temperature_Celsius_RAW_VALUE));
        }
    ...
    protected void createChart() throws Exception {
        ...
        JFreeChart chart = createChart(dataset, "disk temperature", "date", "celsius");
