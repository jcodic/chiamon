 ...
 * @author ddx
 */
public class LogsFarmPlotsTotalChart extends CommonChart {
	...
	List<XYItemDateDouble> ds = new ArrayList<>();
        ...
        for (LogFarmEntry item : items) {
            ...
            ds.add(new XYItemDateDouble(item.getDt(), item.getPlotsTotal()));
        }
    ...
    protected void createChart() throws Exception {
        ...
        JFreeChart chart = createChart(dataset, "total plots", "date", "total plots");
